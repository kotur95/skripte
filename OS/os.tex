...
%            NASLOV                         PODNASLOV                  AUTOR ...
	\title{\textbf{\texttt{\textcolor{blue!50!cyan!70!black}{Operativni sistemi}}} \\ \vspace{1mm} \large{\texttt{\textcolor{blue!50!cyan!70!black}{skripta za praktični deo}}}}
...
Kada govorimo o savremenim operativnim sistemima koji pružaju visok stepen udobnosti krajnjem korisniku, komandna linija se dosta ređe koristi jer mnogobrojne zadatke možemo obaviti putem \texttt{GUI-a} --- grafičkog korisničkog interfejsa. Najčešće se komandna linija u okviru \texttt{GUI-a}  emulira putem specijalnih programa i ponaša se na očekivani način.

\subsection{Komandna linija u Linux okruženju}

Specijalni programi koji nam obezbeđuju emulaciju komandne linije u \texttt{Linux} okruženju nazivaju se: \texttt{terminal emulator} i \texttt{shell}. Ova kombinacija predstavlja komandnu liniju u okviru \texttt{GUI-ja}.
